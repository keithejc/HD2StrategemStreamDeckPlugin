...
namespace Interceptor
{
    public class Input
    {
        ...
        private static AutoResetEvent stoppedEvent = new AutoResetEvent(false);
        ...
        public void Unload()
        {
            ...
            {
                StopThread = true;
                stoppedEvent.WaitOne(5000);
                InterceptionDriver.DestroyContext(context);
                IsLoaded = false;
            }
        }

        //intercept key or mouse events and optionally intercept them
